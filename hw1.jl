...
student = (name = "Anthony Fiddes", kerberos_id = "jazz")
...
# ╔═╡ 40f10236-aede-4d09-8559-8b8a76170b16
function get_greens(image::AbstractMatrix)
	result = get_green.(image)
	return result
end

# ╔═╡ baad6a12-80d9-4363-a077-9120f3bfe2d9
function get_blue(pixel::AbstractRGB)
	return pixel.b
end

# ╔═╡ dc490b25-eff2-4b94-b6e1-db0da571521b
function get_blue(image::AbstractMatrix)
...
function invert(color::AbstractRGB)
	# your code here!
	result = RGB(1 - red(color), 1 - green(color), 1 - blue(color))
	return result
end
...
function noisify(x::Number, s)
	change = rand() * s * rand((-1, 1))
	return clamp(x + change, 0, 1)
end
...
The image is unrecognisable with intensity 2. I'm not 100% sure why and it's bedtime.
"""
